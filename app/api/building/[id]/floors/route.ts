...
/**
 * GET /api/building/:id/floors -> the demo project.
 *
 * A thin alias onto /api/p/siripuram/building/:id/floors, following the same
...
export async function GET(
  ...
  return buildingFloorsRoute(DEFAULT_SLUG, id, req);
}
