...
/**
 * GET /api/building/:id/units -> the demo project.
 *
 * A thin alias onto /api/p/siripuram/building/:id/units, following the same
...
export async function GET(
  ...
  return buildingUnitsRoute(DEFAULT_SLUG, id, req);
}
